...
export default function ChatButton() {
  ...
  return (
    <div className="fixed bottom-8 right-14 z-[900]">
      <div className="relative">
        ...
        <div
          ...
          className="relative rounded-full bg-gradient-to-tr from-purple-600 via-pink-500 to-red-500 size-20 flex items-center justify-center cursor-pointer shadow-2xl hover:scale-110 hover:rotate-6 transition-all duration-300"
        >
